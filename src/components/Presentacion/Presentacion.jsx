	...
	return (
		<div className={s.texts}>
			<div>
				...
				<div>
					<a className={s.descargaCV} href="https://drive.google.com/file/d/1KlFfaux4HL8ZQMP4DRXsbwCWxrxvrzmJ/view?usp=sharing" target="_blank" rel="noopener noreferrer">Ver CV</a>
				</div>
			</div>
